...
namespace Language
{
    public partial class Form1 : Form
    {
        ...
        //            {
        //                MessageBox.Show("O'zgartirmoqchi bo'lgan ma'lumotingizni tanlang");
        //            }
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            using (SQLiteConnection con = new SQLiteConnection(conStr))
                try
                {
                    if (textBox1.Text == "")
                    {
                        MessageBox.Show("O'chirmoqchi bo'lgan malumotizni tanlang");
                    }
                    ...
                    else
                    {
                        ...
                        cmd.ExecuteNonQuery();
                        MessageBox.Show("Ma'lumot o'chrildi");
                        con.Close();
                        populate();
